...
export function extractMarkdownHeaders(markdown: string): { level: number, text: string, id: string }[] {
...
export function extractMarkdownMetadata(markdown: string): { [key: string]: string } {
...
export function parseMarkdownForInteractivity(markdown: string): string {
    let html = markdown;
...
export function loadPlanFile(planPath: string): { content: string, metadata: any } {
    try {
...
export function generateTableOfContents(headers: { level: number, text: string, id: string }[]): string {
...
export function checkPlanPhaseStatus(planPath: string): { phase2: boolean, phase3: boolean, phase2Path?: string, phase3Path?: string } {
