...
function calculateProjectStats(rootPath: string) {
...
export function generateDashboardHtml(rootPath: string): string {
    ...
    return getBaseHtml('Claude Cascade Dashboard', styles + additionalStyles, body);
}