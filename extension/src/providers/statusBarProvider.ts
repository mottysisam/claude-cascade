...
export class StatusBarProvider implements vscode.Disposable {
    ...
    private complianceWatcher: vscode.FileSystemWatcher | undefined;
    private updateInterval: NodeJS.Timeout | undefined;
    private lastNotificationTime: number = 0;
    private readonly NOTIFICATION_COOLDOWN = 1000 * 60 * 10; // 10 minutes
     ...
     */
    private setupComplianceWatcher(): void {
    ...
    private findActivePlan(phase1Files: string[], phase2Files: string[], phase3Files: string[]): string | null {
    ...
    private createTooltip(stats: any): string {
        const lines = [
     ...
     */
    private showComplianceNotification(stats: any): void {
