...
exports.getBaseHtml = exports.setupNavigationHandlers = exports.navigateTo = exports.ViewType = void 0;
...
(function (ViewType) {
    ViewType["Main"] = "main";
    ViewType["PhaseTable"] = "phaseTable";
    ViewType["PlanView"] = "planView";
    ViewType["Analytics"] = "analytics";
})(ViewType = exports.ViewType || (exports.ViewType = {}));
function navigateTo(panel, viewType, params) {
    switch (viewType) {
        case ViewType.Main:
...
function setupNavigationHandlers(panel, rootPath, context) {
...
exports.setupNavigationHandlers = setupNavigationHandlers;
// Helper to generate base HTML with styles and scripts
function getBaseHtml(title, styles, body) {
    return `<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
exports.getBaseHtml = getBaseHtml;
