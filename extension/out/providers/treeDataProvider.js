...
exports.PlanItem = exports.PhaseTreeDataProvider = void 0;
const vscode = require("vscode");
const fs = require("fs");
const path = require("path");
class PhaseTreeDataProvider {
    ...
    getPhases(plansPath) {
        ...
        return phases.map(phase => {
            ...
            const item = new PlanItem(`${phase.name} (${count})`, vscode.TreeItemCollapsibleState.Expanded);
    ...
    getPlanStatus(filename, currentPhasePath) {
...
exports.PhaseTreeDataProvider = PhaseTreeDataProvider;
